...
/**
 * @brief Append an integer value to a string.
 * @param description String to append to
 * @param valu Value to append
 * @param plussed If true, will add a '+' to positive values
 */
static void append_value(string &description, const int valu, const bool plussed) {
    if (valu >= 0 && plussed == 1) {
        description += '+';
    }
...
//
//---------------------------------------------------------------
string get_item_description(const item_def &item, const char verbose, const bool dump) {
    string description;
...
//
//---------------------------------------------------------------
void describe_item(const item_def &item, bool interact) {
    clrscr();
        ...
        ****************************************************************** */
        ...
        case MONS_PLAYER_GHOST: {
            ...
            snprintf(tmp_buff, sizeof(tmp_buff),
                     ...
                     (ghost.values[GVAL_EXP_LEVEL] < 4)
                         ? " weakling"
                         : (ghost.values[GVAL_EXP_LEVEL] < 7)
                               ? "n average"
                               : (ghost.values[GVAL_EXP_LEVEL] < 11)
                                     ? "n experienced"
                                     : (ghost.values[GVAL_EXP_LEVEL] < 16)
                                           ? " powerful"
                                           : (ghost.values[GVAL_EXP_LEVEL] < 22)
                                                 ? " mighty"
                                                 : (ghost.values[GVAL_EXP_LEVEL] < 26)
                                                       ? " great"
                                                       : (ghost.values[GVAL_EXP_LEVEL] < 27)
...
constexpr const char *GOD_DESCRIPTIONS[] = {
    nullptr,

    "Zin is an ancient and revered God, dedicated to the establishment of order" EOL
    ...
    "The Shining One is a powerful crusading deity, allied with Zin in the fight" EOL
    ...
    "Kikubaaqudgha is a terrible Demon-God, served by those who seek knowledge of" EOL
    ...
    "Yredelemnul is worshipped by those who seek powers over death and the undead" EOL
    ...
    "Xom is a wild and unpredictable God of chaos, who seeks not worshippers but" EOL
    ...
    "Vehumet is a God of the destructive powers of magic. Followers gain various" EOL
    ...
    "Okawaru is a dangerous and powerful God of battle. Followers can gain a " EOL
    ...
    "Makhleb the Destroyer is a fearsome God of chaos and violent death. Followers," EOL
    ...
    "Sif Muna is a contemplative but powerful deity, served by those who seek" EOL
                    "magical knowledge. Sif Muna appreciates sacrifices of valuable items, and" EOL
                    "the casting of spells as often as possible.",

    "Trog is an ancient God of anger and violence. Followers are expected to kill" EOL
    ...
    "Nemelex is a strange and unpredictable trickster God, whose powers can be" EOL
    ...
    "Elyvilon the Healer is worshipped by the healers (among others), who gain" EOL
...
void describe_god(const GODS which_god, const bool give_title) {
    ...
    textcolor(colour);
    cprintf(" %s" EOL EOL, god_name(which_god, true));

    textcolor(LIGHTGRAY);
    cputs(GOD_DESCRIPTIONS[which_god]);
    ...
    if (you.religion == which_god) {
        ...
        // based on your god
        if (you.piety > 160) {
            cprintf((which_god == GOD_SHINING_ONE)
                        ? "Champion of Law"
                        : (which_god == GOD_ZIN)
                              ? "Divine Warrior"
                              : (which_god == GOD_ELYVILON)
                                    ...
                                    : (which_god == GOD_OKAWARU)
                                          ? "Master of Thousand Battles"
                                          : (which_god == GOD_YREDELEMNUL)
                                                ? "Master of Eternal Death"
                                                : (which_god == GOD_KIKUBAAQUDGHA)
                                                      ? "Lord of Darkness"
                                                      : (which_god == GOD_MAKHLEB)
                                                            ? "Champion of Chaos"
            ...
            // Xom and no god is handled before
        } else {
            ...
            switch (which_god) {
                ...
                case GOD_XOM:
                    cprintf((you.experience_level >= 20)
                                ? "Xom's favourite toy"
                                : "Toy");
                    break;
    ...
    if (you.religion != which_god) {
        textcolor(colour);
        snprintf(info, INFO_SIZE,
                 (you.penance[which_god] >= 50)
                     ? "%s's wrath is upon you!"
                     : (you.penance[which_god] >= 20)
                           ? "%s is annoyed with you."
                           : (you.penance[which_god] >= 5)
                                 ? "%s well remembers your sins."
                                 : (you.penance[which_god] > 0)
        ...
        {
            cprintf((you.penance[which_god] >= 50)
                         ...
                         (you.piety > 130)
                             ...
                             : (you.piety > 100)
                                   ...
                                   : (you.piety > 70)
                                         ...
                                         : (you.piety > 40)
                                               ? "%s is most pleased with you."
                                               : (you.piety > 20)
                                                     ? "%s has noted your presence."
                                                     : (you.piety > 5)
                                                           ? "%s is noncommittal."
